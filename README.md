...
1407 tests | 0 deps | 27 modules | Bun + Deno + Node.js
...
```bash
bun test tests/    # 1407 tests across 84 files, ~35 seconds
```
...
[AGENTS.md's Known Security Gaps](AGENTS.md#known-security-gaps-items-1-30-resolved-open-items-listed-at-the-end).
