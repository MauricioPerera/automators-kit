...
1322 tests | 0 deps | 27 modules | Bun + Deno + Node.js
...
```bash
bun test tests/    # 1322 tests across 84 files, ~35 seconds
```
...
4 full security audits to date. **Every finding that was independently reproduced is remediated** — 14
from the 2026-08-03 full-codebase audit alone (4 critical, 5 high, 5 medium), including three of its
unreproduced leads that were checked afterwards and all turned out to be real. What remains open is stated
...
[AGENTS.md's Known Security Gaps](AGENTS.md#known-security-gaps-items-1-21-resolved-open-items-listed-at-the-end).
