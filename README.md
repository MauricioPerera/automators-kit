...
1430 tests | 0 deps | 27 modules | Bun + Deno + Node.js
...
Writing your own plugin: use `safeFetch` from `core/net-guard.js` rather than
`fetch` for anything outbound.
...
```bash
bun test tests/    # 1430 tests across 85 files, ~35 seconds
```
...
[AGENTS.md's Known Security Gaps](AGENTS.md#known-security-gaps-items-1-34-resolved-open-items-listed-at-the-end).
