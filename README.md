...
1420 tests | 0 deps | 27 modules | Bun + Deno + Node.js
...
```bash
bun test tests/    # 1420 tests across 85 files, ~35 seconds
```
...
[AGENTS.md's Known Security Gaps](AGENTS.md#known-security-gaps-items-1-33-resolved-open-items-listed-at-the-end).
