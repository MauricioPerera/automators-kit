...
1307 tests | 0 deps | 27 modules | Bun + Deno + Node.js
...
```bash
bun test tests/    # 1307 tests across 84 files, ~35 seconds
```
...
4 full security audits to date. **Every finding that was independently reproduced is remediated** — 11
from the 2026-08-03 full-codebase audit alone (4 critical, 4 high, 3 medium). What remains open is stated
...
[AGENTS.md's Known Security Gaps](AGENTS.md#known-security-gaps-items-1-18-resolved-open-items-listed-at-the-end).
