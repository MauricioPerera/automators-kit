...
1333 tests | 0 deps | 27 modules | Bun + Deno + Node.js
...
```bash
bun test tests/    # 1333 tests across 84 files, ~35 seconds
```
...
4 full security audits to date. **Every finding that was independently reproduced is remediated** — 17
from the 2026-08-03 full-codebase audit alone (4 critical, 6 high, 7 medium), including eight of its
unreproduced leads that were checked afterwards; all eight turned out to be real bugs. What remains open is stated
...
[AGENTS.md's Known Security Gaps](AGENTS.md#known-security-gaps-items-1-24-resolved-open-items-listed-at-the-end).
